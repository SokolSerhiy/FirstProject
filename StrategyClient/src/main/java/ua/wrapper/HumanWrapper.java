...
public class HumanWrapper implements Collector{

	private static final String FIELD_NAME = "bellyful";
	
	private static final String COLLECT_FOOD_METHOD_NAME = "collectFood";

	private static final String COLLECT_WOOD_METHOD_NAME = "collectWood";
	
	private static final String COLLECT_STONE_METHOD_NAME = "collectStone";
	
	private static final String COLLECT_IRON_METHOD_NAME = "collectIron";
	...
	public HumanWrapper(Object human, ResourceName colectedResource) {
		this.human = human;
