...
public class GameResource extends ResourceSupport{
	...
	public GameResource(int lastDoneTask, int food, int wood, int stone, int iron, int foodCollectors, int woodCollectors, int stoneCollectors, int ironCollectors) {
	...
	public String toString() {
		return "GameResource [lastDoneTask=" + lastDoneTask + ", food=" + food + ", wood=" + wood + ", stone=" + stone
